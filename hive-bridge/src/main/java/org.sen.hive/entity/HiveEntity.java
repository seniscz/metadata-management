...
public class HiveEntity implements Serializable {
    ...
    public static final String KEY_EXECUTER_ADDRESS = "executerAddress";
    // query info
    ...
    public String getExecuterAddress() {
        return (String) entity.get(KEY_EXECUTER_ADDRESS);
    }

    public void setExecuterAddress(String executerAddress) {
        entity.put(KEY_EXECUTER_ADDRESS, executerAddress);
    }
