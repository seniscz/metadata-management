...
import static org.sen.hive.HiveHookContext.QNAME_SEP_ENTITY_NAME;

/**
 * @ClassName BaseHiveEvent
 * @Description TODO
 * @Author chezhao
...
public class BaseHiveEvent {
    ...
    protected Map<String, Object> toDbEntity(Database db) throws Exception {
    ...
    protected Map<String, Object> toTableEntity(Table table) throws Exception {
        //HIVE_TYPE_TABLE
    ...
    protected Map<String, Object> toPartitionEntity(Partition partition) throws Exception {
        Map<String, Object> ret = null;
        if (partition != null) {
            ret = new HashMap<>();
    ...
    protected String getQualifiedName(LineageInfo.BaseColumnInfo column) {
        ...
        if (colName == null) {
            return (dbName + QNAME_SEP_ENTITY_NAME + tableName).toLowerCase();
        } else {
            return (dbName + QNAME_SEP_ENTITY_NAME + tableName + QNAME_SEP_ENTITY_NAME + colName).toLowerCase();
        }
    }
